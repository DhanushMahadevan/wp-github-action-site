...
<div class="wp-block-cover" style="padding-top:20px;padding-right:0px;padding-bottom:0px;padding-left:0px"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-80 has-background-dim" style="background-color:#181818"></span><img class="wp-block-cover__image-background wp-image-1185" alt="" src="' . esc_url( INTRACE_URI ) . 'assets/img/architecture-house-home-pool-ceiling-italy-599832-pxhere.com.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:pattern {"slug":"intrace/core-header"} /-->

<!-- wp:group {"style":{"spacing":{"padding":{"top":"280px","bottom":"380px"}}},"layout":{"contentSize":"1140px"}} -->
<div class="wp-block-group" style="padding-top:280px;padding-bottom:380px"><!-- wp:columns -->
...
<h2 class="has-text-align-center has-intrace-accent-color has-text-color has-heading-4-font-size" style="font-style:normal;font-weight:600;line-height:1;text-transform:capitalize;letter-spacing:0em">Page Not Found</h2>
<!-- /wp:heading -->
