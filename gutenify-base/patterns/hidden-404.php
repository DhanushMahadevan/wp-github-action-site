...
<?php echo esc_html__( '4', 'gutenify-base' ); ?><mark style="background-color: rgba(0, 0, 0, 0); color: #01dacc" class="has-inline-color"><?php echo esc_html__( '0', 'gutenify-base' ); ?></mark><?php echo esc_html__( '4', 'gutenify-base' ); ?>
		</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'This page could not be found. Maybe try a search?', 'gutenify-base' ); ?> </p>
<!-- /wp:paragraph -->
